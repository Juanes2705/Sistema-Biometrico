...
class Paginacion {
    ...
    {
        $this->pagina_actual = max(1, (int) $pagina_actual); // Asegura que nunca sea menor que 1
    ...
    public function offset() {
        ...
        return max(0, $offset); // Asegura que no sea negativo
    }
    

    public function total_paginas() {
        return max(1, ceil($this->total_registros / $this->registros_por_pagina));
    }
