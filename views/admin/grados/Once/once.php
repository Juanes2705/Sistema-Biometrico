...
<div class="dashboard__contenedor">
    ...
    $estudiantesConTagEspecifico = array_filter($estudiante, function($estudiantes) {
        ...
        return in_array('Once', array_map('trim', $tagsArray)); // Ajusta 'Once' al tag específico
    });
            ...
            <?php foreach ($estudiantesConTagEspecifico as $estudiantes) { ?>
                <tr class="table__tr">
                    ...
                    <td class="table__td--acciones">
                        <a class="table__accion table__accion--editar" href="/admin/grados/Once/editar?id=<?php echo htmlspecialchars($estudiantes->id, ENT_QUOTES, 'UTF-8'); ?>">
    ...
    <?php } else { ?>
        <p class="text-center">No hay Estudiantes de Once</p>
    <?php } ?>
</div>
