...
<div class="dashboard__contenedor-boton">
    <a class="dashboard__boton-mate" href="/admin/grados/Decimo/crear">
...
<div class="dashboard__contenedor">
    ...
    $estudiantesConTagEspecifico = array_filter($estudiante, function($estudiantes) {
        ...
        return in_array('Decimo', array_map('trim', $tagsArray)); // Ajusta 'Sociales' al tag específico
    });
            ...
            <?php foreach ($estudiantesConTagEspecifico as $estudiantes) { ?>
                <tr class="table__tr">
                    ...
                    <td class="table__td--acciones">
                        <a class="table__accion table__accion--editar" href="/admin/grados/Decimo/editar?id=<?php echo htmlspecialchars($estudiantes->id, ENT_QUOTES, 'UTF-8'); ?>">
                            <i class="fa-solid fa-user-pen"></i>
                            Editar
                        </a>

                        <form method="POST" action="/admin/grados/Decimo/eliminar" class="table__formulario">
    ...
    <?php } else { ?>
        <p class="text-center">No hay Estudiantes de Decimo</p>
    <?php } ?>
</div>
