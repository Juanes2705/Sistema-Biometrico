...
class Vigilantes extends ActiveRecord{
    protected static $tabla = 'vigilantes';
    protected static $columnasDB = ['id', 'nombre', 'apellido', 'email', 'password', 'tags', 'confirmado', 'token', 'vigilante'];
    ...
    public function __construct($args = [])
    {
        ...
        $this->vigilante = $args['vigilante'] ?? 1;
